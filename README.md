...
Kick both processes off independently — the writer writes, but how does the reader know which shared memory segment the writer is using?
...
> ⚠️ **Danger:** Shared memory persists until it is explicitly unlinked/deleted or the system reboots. If your program crashes or exits without cleaning up, the segment just sits there.
